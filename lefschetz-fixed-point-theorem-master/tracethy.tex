...
\begin{defn}
  ...
  the \tdef{dual} $X$. We denote by $\cC^{\dual}\subseteq \cC$ the full subcategory
...
\begin{defn}
  ...
  \[ \tr{f}{\cC} \colon  Y \rar{Y \otimes \coev_X} Y\otimes X \otimes X^{\vee} \rar{f \otimes \id} Z\otimes X \otimes X^{\vee} \rar{Z\otimes \tau} Z\otimes  X^{\vee} \otimes X \rar{Z\otimes \ev_X} Z .\]
  We refer to $\tr{\id_X}{\cC}\colon \1_{\cC} \to \1_{\cC}$ as the \tdef{dimension} of
  $X$ and denote it by $\dim{X}{\cC}$.
\end{defn}
